...
int play(int shuffledCards[])
{
    ...
    while (TRUE)
    {
        ...
        if (situation == 1)
        {
            board(score1, score2, symbolP1, numP1, symbolP2, numP2, symbolP3, numP3, symbolP4, numP4, situation, symP1, numberP1);
            while (TRUE)
            {
            ...
            result = judge(symbolP1, numP1, symbolP2, numP2, symbolP3, numP3, symbolP4, numP4, situation, bakhshname); /*analyzing the boaed*/
            startCard = playbot(p2, bakhshname, result, TEAM2, symbol);                                                /*player 2 plays*/
            numP2 = startCard % 11;
            symbolP2 = startCard / 11;
            result = judge(symbolP1, numP1, symbolP2, numP2, symbolP3, numP3, symbolP4, numP4, situation, bakhshname); /*analyzing the boaed*/
            startCard = playbot(p3, bakhshname, result, TEAM1, symbol);                                                /*player 3 plays*/
            numP3 = startCard % 11;
            symbolP3 = startCard / 11;
            result = judge(symbolP1, numP1, symbolP2, numP2, symbolP3, numP3, symbolP4, numP4, situation, bakhshname); /*analyzing the boaed*/
            startCard = playbot(p4, bakhshname, result, TEAM2, symbol);                                                /*player 4 plays*/
            numP4 = startCard % 11;
            symbolP4 = startCard / 11;
        }
        else if (situation == 2)
        {
            startCard = starter(p2, bakhshname);
            symbol = startCard / 11;
            numP2 = startCard % 11;
            symbolP2 = startCard / 11;
            result = judge(symbolP1, numP1, symbolP2, numP2, symbolP3, numP3, symbolP4, numP4, situation, bakhshname); /*analyzing the boaed*/
        ...
        {
            startCard = starter(p3, bakhshname);
            symbol = startCard / 11;
            numP3 = startCard % 11;
            symbolP3 = startCard / 11;
            result = judge(symbolP1, numP1, symbolP2, numP2, symbolP3, numP3, symbolP4, numP4, situation, bakhshname); /*analyzing the boaed*/
            startCard = playbot(p4, bakhshname, result, TEAM1, symbol);                                                /*player 3 plays*/
            numP4 = startCard % 11;
            symbolP4 = startCard / 11;
            board(score1, score2, symbolP1, numP1, symbolP2, numP2, symbolP3, numP3, symbolP4, numP4, situation, symP1, numberP1);
            flag = 0;
            ...
            numberP1[playedCard] = 0;
            result = judge(symbolP1, numP1, symbolP2, numP2, symbolP3, numP3, symbolP4, numP4, situation, bakhshname); /*analyzing the boaed*/
            startCard = playbot(p2, bakhshname, result, TEAM2, symbol);                                                /*player 4 plays*/
            numP2 = startCard % 11;
            symbolP2 = startCard / 11;
        }
        else if (situation == 4)
        {
            startCard = starter(p4, bakhshname);
            symbol = startCard / 11;
            numP4 = startCard % 11;
            symbolP4 = startCard / 11;
            board(score1, score2, symbolP1, numP1, symbolP2, numP2, symbolP3, numP3, symbolP4, numP4, situation, symP1, numberP1);
            ...
            numberP1[playedCard] = 0;
            result = judge(symbolP1, numP1, symbolP2, numP2, symbolP3, numP3, symbolP4, numP4, situation, bakhshname); /*analyzing the boaed*/
            startCard = playbot(p2, bakhshname, result, TEAM1, symbol);                                                /*player 3 plays*/
            numP2 = startCard % 11;
            symbolP2 = startCard / 11;
            result = judge(symbolP1, numP1, symbolP2, numP2, symbolP3, numP3, symbolP4, numP4, situation, bakhshname); /*analyzing the boaed*/
            startCard = playbot(p3, bakhshname, result, TEAM2, symbol);                                                /*player 4 plays*/
            numP3 = startCard % 11;
            symbolP3 = startCard / 11;
        }
        result = judge(symbolP1, numP1, symbolP2, numP2, symbolP3, numP3, symbolP4, numP4, situation, bakhshname); /*analyzing the boaed*/
